...
$client = localAPI('GetClientsDetails',array( 'clientid' => $vars['userid'], 'stats' => false, ), false);
...
if(!$nfe_for_invoice['status']) {
    ...
    $disabled = array('a'=>'','b'=>'disabled="disabled"','c'=>'disabled="disabled"','d'=>'disabled="disabled"' );
}
